const Testimonies = () => {
  return (
    <section className="bg-[#5f4c76] my-20 ">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-white">
            Testimonials
          </h2>
          <p className="mb-8 font-light  lg:mb-16 sm:text-xl text-gray-200">
            Explore the whole collection of open-source web components and
            elements built with the utility classes from Tailwind
          </p>
        </div>
        <div className="grid mb-8 lg:mb-12 lg:grid-cols-2">
          <figure className="flex flex-col justify-center items-center p-8 text-center bg-gray-800 border-b border-gray-700 md:p-12 lg:border-r ">
          ...
          <figure className="flex flex-col justify-center items-center p-8 text-center  border-b bg-gray-800 border-gray-700 md:p-12 ">
            <blockquote className="mx-auto mb-8 max-w-2xl text-gray-400">
              <h3 className="text-lg font-semibold text-white">
        ...
        <div className="text-center">
          <a
            href="#"
            className="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100  "
          >
            Show more...
          </a>
        </div>
